...
try:
    ...
    actions = ActionChains(driver, 91)
    ...
    while True:
        # defines the prices of all the buildings (from most expensive to least)
            ...
            if buildingPrice[item].text != "" and buildingPrice[item - 1].text != "" and \
                ...
                if numconvert(buildingPrice[item - 1].text) / numconvert(buildingPrice[item].text) > \
                    ...
                    try:
                        ...
                        sleep(0.1)
                    except StaleElementReferenceException or IndexError or NoSuchElementException:
                        print("output value not read")
                        pass
